...
import static View_GUI.controller.tela_principalController.isbn;
 ...
 * A validação dos dados é feita antes de enviar a avaliação ao controller View_GUI.
 */
public class tela_avaliacao_livroController implements Initializable {
    ...
    void clicarConfirmar(ActionEvent event) {
        try {
            ...
            // Chama o controller View_GUI para registrar a avaliação
     ...
     * Volta para a tela View_GUI sem salvar a avaliação.
     *
     * @param event Evento de clique no botão
     */
    @FXML
     ...
     * @param mensagem Mensagem View_GUI exibida ao usuário
     */
