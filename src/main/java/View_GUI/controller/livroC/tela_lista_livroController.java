 ...
 * carregar os dados da lista de livros e tratar a ação de retorno para a tela View_GUI.
 */
public class tela_lista_livroController implements Initializable {
     ...
     * Muda a cena para a tela View_GUI da aplicação.
     *
    ...
    /**
     * Carrega os livros cadastrados no controlador View_GUI e popula a tabela.
     */
