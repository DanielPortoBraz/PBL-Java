 ...
 *
 * Também gerencia o evento de retorno à tela principal.
 */
public class tela_lista_filmeController implements Initializable {
    ...
    /**
     * Trata o evento de clique no botão "Retornar", que muda a cena para a tela principal.
     *
    ...
    /**
     * Carrega a lista de filmes do controlador principal e popula a tabela da interface.
     */
